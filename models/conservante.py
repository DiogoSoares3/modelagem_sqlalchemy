...
class Conservante(ModelBase):  # Herdando modelo base
    __tablename__: str = 'conservantes' # Nome da tabela no banco de dados no plural
    ...
    descricao: str = sa.Column(sa.String(45), nullable=False) # Não nulo com limite de até 45 caracteres
